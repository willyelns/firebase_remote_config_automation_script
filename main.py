...
python remote_config.py --action=current_version --platform=<ios/android/both> --version=<APP_NEW_CURRENT_VERSION>
python remote_config.py --action=accepted_version --platform<ios/android/both> --version=<APP_NEW_ACCEPTED_VERSION>''')
